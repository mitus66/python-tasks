...
'''
Щоб створити unit-тести для модуля main.py, ми будемо використовувати бібліотеку unittest. Ми протестуємо різні функції, які визначені у файлі main.py.
...
Зміни у main.py
Додатково, для кращого відокремлення функціональності та тестування, рекомендується трохи змінити модуль main.py, щоб забезпечити легше тестування.
...
Ці зміни дозволять запускати скрипт з аргументами командного рядка, наприклад: python main.py data/elements.txt Таким чином, ми створили unit-тести для всіх основних функцій у main.py, забезпечивши перевірку коректної роботи програми.
'''
